  ...
  return (
    <div className="col">
      <div className="product-card h-100 py-3 d-flex flex-column justify-content-between">
        ...
        <div>
          <h4>{productName}</h4>
          <div className="d-flex justify-content-around w-100 bg-dark text-light fs-5 align-items-center">
            <p className="mb-1 original-price">
              <strike className="">{originalPrice} BDT.</strike>
            </p>
            <p className="mb-1 text-warning fw-bold discount-price">
              {discountPrice} BDT.
            </p>
          </div>
          ...
          <button className="btn-generic btn-red">
            Buy Now <i className="fas fa-cart-plus ms-1"></i>
          </button>
        </div>
      </div>
    </div>
